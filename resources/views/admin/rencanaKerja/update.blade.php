            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Edit Rencana Kerja</li>
                    </ol>
                </nav>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        {{-- ✅ Form Edit Data --}}
                        <form action="{{ route('rencana_kerja.update', $rencanaKerja->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-3">
                                    ...
                                    <select name="id_strategi" id="id_strategi" class="form-select" required>
                                        ...
                                        @foreach ($strategis as $data)
                                            <option value="{{ $data->id }}"
                                                {{ $rencanaKerja->id_strategi == $data->id ? 'selected' : '' }}>
                                                {{ $data->strategi }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="id_opd" class="form-select" required>
                                        ...
                                        @foreach ($opd as $data)
                                            <option value="{{ $data->id }}"
                                                {{ $rencanaKerja->id_opd == $data->id ? 'selected' : '' }}>
                                                {{ $data->opd }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="rencana_aksi" id="rencana_aksi" rows="3" class="form-control" required>{{ old('rencana_aksi', $rencanaKerja->rencana_aksi) }}</textarea>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="kegiatan" id="kegiatan" class="form-control"
                                        value="{{ old('kegiatan', $rencanaKerja->kegiatan) }}" required>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="sub_kegiatan" id="sub_kegiatan" class="form-control"
                                        value="{{ old('sub_kegiatan', $rencanaKerja->sub_kegiatan) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_program" id="nama_program" class="form-control"
                                    value="{{ old('nama_program', $rencanaKerja->nama_program) }}" required>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="lokasi" id="lokasi" class="form-control"
                                        value="{{ old('lokasi', $rencanaKerja->lokasi) }}" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="volume" class="form-label">Volume Target</label>
                                    <input type="text" name="volume" id="volume" class="form-control"
                                        value="{{ old('volume', $rencanaKerja->volume) }}" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="satuan" class="form-label">Satuan</label>
                                    <input type="text" name="satuan" id="satuan" class="form-control"
                                        value="{{ old('satuan', $rencanaKerja->satuan) }}" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="tahun" class="form-label">Tahun</label>
                                    <input type="text" name="tahun" id="tahun" class="form-control"
                                        value="{{ old('tahun', $rencanaKerja->tahun) }}" required>
                                </div>
                            </div>
                            ...
                            <fieldset class="border p-3 rounded-3 mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody id="anggaran-table-body">
                                            ...
                                            @if (is_array($rencanaKerja->anggaran) && is_array($rencanaKerja->sumberdana))
                                                @foreach ($rencanaKerja->anggaran as $index => $anggaranValue)
                                                    @php
                                                        $uniqueId = 'row-initial-' . $index;
                                                        $sumberDanaValue = $rencanaKerja->sumberdana[$index] ?? '';
                                                    @endphp
                                                    <tr id="{{ $uniqueId }}">
                                ...
                                <div class="mt-2">
                                    ...
                                    <textarea name="keterangan" class="form-control" rows="3">{{ old('keterangan', $rencanaKerja->keterangan) }}</textarea>
                                </div>
                            </fieldset>
                            ...
                            <div class="text-end">
                                ...
                                <a href="{{ route('rencanakerja') }}" class="btn btn-secondary">Batal</a>
                            </div>
                        </form>
